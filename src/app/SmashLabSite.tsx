...
const FieryLogo: React.FC<FieryLogoProps> = ({ src, alt = "Smash Lab mark" }) => {
  ...
  return (
    <div className="fiery-wrap">
      ...
      {/* main logo image */}
      <img src={src} alt={alt} className="h-48 w-48 rounded-full sm:h-66 sm:w-66" />
    </div>
  );
};
    ...
    >
      ...
      <section id="home" className="relative overflow-hidden">
        ...
        <motion.div
          ...
          className="mx-auto flex max-w-6xl flex-col items-center px-4 py-10 text-center sm:px-6 lg:px-8 lg:py-11 sm:py-16"
        >
          {/* fiery logo */}
